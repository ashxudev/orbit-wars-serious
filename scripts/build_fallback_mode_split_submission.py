"""Build the fallback mode-split reserve candidate as one Python file."""
...
from agents.fallback_mode_split import build_source
...
def main(argv: Iterable[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build fallback mode-split standalone Orbit Wars agent.",
    )
    parser.add_argument(
        "--output",
        required=True,
