"""Build the fallback retention mode-split candidate as one Python file."""
...
from agents.fallback_mode_split_retention import build_source
...
def main(argv: Iterable[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build fallback retention mode-split standalone agent.",
    )
    parser.add_argument(
        "--output",
        required=True,
