...
_EVAL_PATCH = (
    ...
    "            )\n"
    "        )\n"
    "        already_doomed_source = (\n"
    "            baseline_source_lost is not None\n"
    "            and baseline_source_lost <= SOURCE_LOSS_GUARD_TICKS\n"
    "            and owner[ti] != me\n"
    "            and not funnel\n"
    "        )\n"
    "        if already_doomed_source:\n"
    "            doomed_source_penalty = (\n"
    "                10.0\n"
    "                + 18.0 * pprod[si]\n"
    "                + max(0, SOURCE_LOSS_GUARD_TICKS - baseline_source_lost)\n"
    "            )\n"
    "            V -= doomed_source_penalty\n"
    "            if pprod[si] >= 3 and baseline_source_lost <= 12:\n"
    "                return None\n"
